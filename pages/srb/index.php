...
<body>
    ...
    <div class="form-container">
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <input type="text" name="password" placeholder="unesite šifru" class="box" required>
            <input type="text" name="cpassword" placeholder="potvrdite šifru" class="box" required>
            ...
            <p>Već imate nalog?<a href="pages/srb/login.php">Prijavite se! </a></p>
        </form>
